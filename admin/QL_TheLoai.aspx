<%@ Page Title="Administrator Management" Language="C#" MasterPageFile="~/admin/Master_Admin.master" AutoEventWireup="true" CodeFile="QL_TheLoai.aspx.cs" Inherits="admin_QL_TheLoai" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server"><p> Nhập vào số Mã Thể Loại cần xóa :
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [MaTheLoai], [TenTheLoai] FROM [TheLoai]"></asp:SqlDataSource>
        </asp:View>
